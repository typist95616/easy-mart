...
export default function Footer() {
    return (
        <div className="whole-footer-root">
            <div className="footer-items">
                <div className="footer-spacer"></div>
                <Image src={logo} alt="footer-logo" className="footer-logo"></Image>
                <div className="footer-spacer-between-items"></div>
                ...
                <div className="footer-subGroup">
                    ...
                    <div className="footer-company footer-contents">
                        <div className="footer-subHeader">Company</div>
                ...
                <div className="footer-social footer-contents">
                    <div className="footer-subHeader">Social</div>
